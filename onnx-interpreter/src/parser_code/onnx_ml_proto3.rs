...
impl TypeProto {
    ...
    pub fn opaque_type(&self) -> &type_proto::Opaque {
        match self.value {
            ::std::option::Option::Some(type_proto::Value::OpaqueType(ref v)) => v,
            _ => <type_proto::Opaque as ::protobuf::Message>::default_instance(),
        }
    }
    ...
    pub fn has_opaque_type(&self) -> bool {
        match self.value {
            ::std::option::Option::Some(type_proto::Value::OpaqueType(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_opaque_type(&mut self, v: type_proto::Opaque) {
        self.value = ::std::option::Option::Some(type_proto::Value::OpaqueType(v))
    }

    // Mutable pointer to the field.
    pub fn mut_opaque_type(&mut self) -> &mut type_proto::Opaque {
        if let ::std::option::Option::Some(type_proto::Value::OpaqueType(_)) = self.value {
        } else {
            self.value = ::std::option::Option::Some(type_proto::Value::OpaqueType(type_proto::Opaque::new()));
        }
        match self.value {
            ::std::option::Option::Some(type_proto::Value::OpaqueType(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_opaque_type(&mut self) -> type_proto::Opaque {
        if self.has_opaque_type() {
            match self.value.take() {
                ::std::option::Option::Some(type_proto::Value::OpaqueType(v)) => v,
                _ => panic!(),
            }
        } else {
            type_proto::Opaque::new()
        }
    }
}
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                58 => {
                    self.value = ::std::option::Option::Some(type_proto::Value::OpaqueType(is.read_message()?));
                },
                50 => {
                    self.denotation = is.read_string()?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let ::std::option::Option::Some(ref v) = self.value {
            match v {
                ...
                &type_proto::Value::OpaqueType(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
            };
...
pub mod type_proto {
    ...
    pub enum Value {
        ...
        // @@protoc_insertion_point(oneof_field:onnx.TypeProto.opaque_type)
        OpaqueType(Opaque),
    }
    ...
    #[derive(PartialEq,Clone,Default,Debug)]
    // @@protoc_insertion_point(message:onnx.TypeProto.Opaque)
    pub struct Opaque {
        // message fields
        // @@protoc_insertion_point(field:onnx.TypeProto.Opaque.domain)
        pub domain: ::std::string::String,
        // @@protoc_insertion_point(field:onnx.TypeProto.Opaque.name)
        pub name: ::std::string::String,
        // special fields
        // @@protoc_insertion_point(special_field:onnx.TypeProto.Opaque.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }

    impl<'a> ::std::default::Default for &'a Opaque {
        fn default() -> &'a Opaque {
            <Opaque as ::protobuf::Message>::default_instance()
        }
    }
    ...
    impl ::protobuf::Message for Opaque {
        ...
        fn default_instance() -> &'static Opaque {
            static instance: Opaque = Opaque {
                domain: ::std::string::String::new(),
                name: ::std::string::String::new(),
                special_fields: ::protobuf::SpecialFields::new(),
            };
